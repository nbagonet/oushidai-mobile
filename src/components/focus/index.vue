          ...
          .content-box
            ...
            .attr
              ...
              .count
                ...
                .like-num(v-if="item.like.num | strToNumber")
...
module.exports = {
  ...
  vuex: {
    getters: {
      list: state => state.focus.list
      // type: state => state.focus.type
    },
    actions: {
      getFocusData
    }
  ...
  ready: function () {
    this.getFocusData(this, '.slider-focus', '.slider-focus-pagination')
  }
}
</script>
