...
export const initMock = function () {
  ...
  if (_host.indexOf('localhost') !== -1 || _host.indexOf('192.168.') !== -1 || _host.indexOf('127.0.0.1') !== -1 || _host.indexOf('github') !== -1) {
    // console.log(Mock)
    // 配置Mock
    Mock.setup({
      timeout: '10-300'
    ...
    Mock.mock(/\/information\/ajax\/get_list(.*)/, 'get', {
      ...
      'data': {
        'list|10': [{
          ...
          'pic': function () {
            return '//temp.im/' + Mock.Random.integer(350, 600) + 'x' + Mock.Random.integer(300, 1200)
          },
          'pic_size': {
            'w': function () {
    ...
    Mock.mock(/\/praise\/ajax\/get_userpage_praise_list(.*)/, 'get', {
      ...
      'data': {
        'list|10': [{
          ...
          'pic': function () {
            return '//temp.im/' + Mock.Random.integer(700, 1200) + 'x' + Mock.Random.integer(300, 1200)
          },
          'pic_size': {
            'w': function () {
              return Mock.Random.integer(700, 1200)
    ...
    Mock.mock(/\/information\/ajax\/get_content(.*)/, 'get', {
      ...
      'data': {
        ...
        'cover': function () {
          return '//temp.im/' + Mock.Random.integer(350, 600) + 'x' + Mock.Random.integer(150, 300)
        },
        'title': function () {
    ...
    Mock.mock(/\/information\/ajax\/get_author_info(.*)/, 'get', {
      ...
      'data': {
        ...
        'banner': function () {
          return '//oushinet.alltosun.net/img/tmp/user-banner/' + Mock.Random.integer(1, 11) + '.jpg'
        },
        'type|1': ['writer', 'mediaOrg'], // ['writer', 'mediaOrg', 'eventOrg', 'user'],
        'level|0-9': 1,
    ...
    Mock.mock(/\/media_org\/ajax\/get_media_org_intro(.*)/, 'get', {
      ...
      'data': {
        ...
        'qr': '//www.oushidai.com/static/upload/2016/01/22/20160122185637000000_1_158648_39.jpg',
        'email': function () {
      ...
      'data': {
        'list|10': [{
          'info': {
            ...
            'avatar': function () {
              return '//temp.im/60x60/?' + Mock.Random.id()
            },
            'homepage': '#',
            'type|1-2': [{
          ...
          'article': {
            ...
            'list': [{
              'title': '门儿文章测试标题',
              'id': '91',
              'link': '//oushinet.alltosun.net/information/pc/91'
            }]
          }
        }]
      }
    ...
    //       },
    //       'pic': function () {
    //         return '//temp.im/' + Mock.Random.integer(400, 600) + 'x' + Mock.Random.integer(400, 600)
    //       },
    //       'pic_size': {
    //         'w': '457',
    //         'h': '276'
    ...
    Mock.mock(/\/activity\/ajax\/activity_content(.*)/, 'get', {
      'data': {
        ...
        'contact': {
          ...
          'site': '//www.baidu.com/dsafasf/ds/af/asfds/f/ds/fsd/fd/sf/sdf/s/fds/f/dsf/dsf/sdf/sd/',
          'tel|13980000000-13989999999': 1
        },
        'cover': function () {
          return '//temp.im/' + Mock.Random.integer(350, 600) + 'x' + Mock.Random.integer(150, 300)
